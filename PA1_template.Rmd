...
```{r identify/5-min/interval, echo=TRUE}
...
Case 1: Including 0 steps
```{r New_mean&median_case1, echo=TRUE}
...
```
Case 2: Excluding 0 steps
```{r New_mean&median_case2, echo=TRUE}
...
```{r panel, echo=TRUE, fig.height=4}
